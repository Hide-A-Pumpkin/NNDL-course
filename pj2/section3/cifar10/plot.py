...
class CNNLayerVisualization():
    ...
    def hook_layer(self):
        ...
        self.model.conv3.register_forward_hook(hook_function)
    ...
    def visualise_layer_with_hooks(self):
        ...
        # optimizer = torch.optim.SGD([self.processed_image], lr = 10,weight_decay=1e-5)
        ...
        for i in range(1, 151):
            ...
            if i % 50 == 0:
                cv2.imwrite('./generated/lc' + str(self.selected_layer) +

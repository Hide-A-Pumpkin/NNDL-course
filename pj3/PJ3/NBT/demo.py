...
if __name__ == '__main__':
    ...
    parser.add_argument('--start_from', type=str, default='/remote-home/zhaoxinyi/NeuralBabyTalk/save/coco_nbt_new/', help='')
    parser.add_argument('--load_best_score', type=int, default=1,
                    help='Do we load previous best score when resuming training.')     
    parser.add_argument('--id', type=str, default='',
                    help='an id identifying this run/job. used in cross-val and appended when writing progress files')
    parser.add_argument('--image_path', type=str, default='/remote-home/zhaoxinyi/',
    ...
    parser.add_argument('--cbs_tag_size', type=int, default=3,
                    help='whether use constraint beam search.')
    parser.add_argument('--cbs_mode', type=str, default='novel',
    ...
    parser.add_argument('--data_path', type=str, default='/remote-home/zhaoxinyi/NeuralBabyTalk/data')
    ...
    print('saving...')
    json.dump(predictions, open('vis.json', 'w'))

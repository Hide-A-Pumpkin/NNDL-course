...
def create_dataset(dataset, config, min_scale=0.5,valid_filename='',test_filename=''):
    ...
    elif dataset=='caption_coco_f1':   
        train_dataset = coco_karpathy_train(transform_train, config['image_root'], config['ann_root_DCC'], prompt=config['prompt'])
        val_dataset = coco_karpathy_caption_eval(transform_test, config['image_root'], config['ann_root_DCC'], 'val',valid_filename,'')
        test_dataset = coco_karpathy_caption_eval(transform_test, config['image_root'], config['ann_root_DCC'], 'test','',test_filename)   
        return train_dataset, val_dataset, test_dataset

...
def oracle_fs():
    train_data_path = args.dataset_path+'img/oracle_200_' + str(args.n_shots[0]) + '_shot/train/'
    test_data_path = args.dataset_path+'img/oracle_200_' + str(args.n_shots[0]) + '_shot/test/'
...
def oracle_trans():
    ...
    test_data_path = '../oracle_fs/img/oracle_200_'+str(args.n_shots[0])+'_shot/test'
